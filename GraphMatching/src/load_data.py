...
try:
    from bignn_dataset import BiLevelDataset, OurStringPdbDataset
except:
    print('To Ken: bignn_dataset not loaded!')
...
def load_dataset(name, tvt, align_metric, node_ordering, skip_pairs=False, node_feats=None):
    ...
    if ld:
        ...
        if dataset_type == 'OurDataset':
            ...
            rtn = BiLevelDataset(None, None, None, None, None, None, None, None, None,
                                 None, None, None, None, ld)
        elif dataset_type == "OurStringPdbDataset":
            rtn = OurStringPdbDataset(None, None, None, None, None, None, None,
                                      None, None, None, None, None, None, None,
                                      None, None, None, None, None, ld)
            print("Total number of pairs = {}".format(len(rtn.get_all_pairs())))
            print("Total number of proteins = {}".format(
                len(rtn.total_string_ids)))
            print("Total number of pdb graphs = {}".format(rtn.num_graphs()))
        else:
...
if __name__ == '__main__':
    ...
    for name in names:
        print("'/home/yba/Documents/GraphMatching/save/dataset/{}_test_bfs',".format(name))
    exit(-1)


    # name = 'mcsplain-connected'
    # name = 'redditmulti10k'
    # name = 'imdbmulti'
    for name in names:
    ...
    # dataset.load_glabels('discrete', '/home/yba/Documents/GraphMatching/data/IMDBMulti/glabels.txt')
    # save(dataset.__dict__, '/home/yba/Documents/GraphMatching/data/IMDBMulti/xx.klepto')
    ...
    # dataset.save_graphs_as_gexf()
    '''
    # dataset = load_dataset('circuit', 'all', 'mcs', None)
    # print(dataset)
    # dataset.print_stats()
